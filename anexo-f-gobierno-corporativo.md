...
La inactividad total o parcial de EL PROYECTO no producirá automáticamente la extinción, transferencia o reducción de los derechos históricos y económicos reconocidos a las partes.

En particular, la reducción de actividad operativa de ANDRÉS DAVID MEJÍA HERRERA no afectará:

- el reconocimiento de su Capital Empresarial Fundacional;
- sus inversiones posteriores;
- sus derechos económicos consolidados;
- la propiedad de sus bienes personales;
- sus derechos sobre préstamos, anticipos o reembolsos;
- su participación en procesos de valoración, Buy-Out, venta, reorganización o liquidación.

La ausencia de nuevos aportes económicos no será utilizada como criterio para reducir derechos ya adquiridos o desconocer el valor históricamente construido.

La ejecución de funciones mediante delegados, proveedores, empleados, contratistas, herramientas tecnológicas o terceros no se considerará abandono cuando EL FUNDADOR conserve razonablemente la orientación estratégica o haya dispuesto una transición operativa adecuada.

La modificación en la forma de trabajar no equivale a incumplimiento.

Por tanto, EL FUNDADOR podrá:

- delegar edición;
- delegar producción;
- delegar administración;
- contratar gestión comercial;
- contratar manejo de redes;
- reducir su participación diaria;
- ejercer dirección mediante supervisión;
- suspender aportes personales;
- concentrarse en nuevas líneas de negocio;

sin perder por ello el reconocimiento de derechos históricos o económicos.

Lo anterior no protege actos de fraude, apropiación, ocultamiento deliberado, destrucción de evidencia o incumplimiento grave probado.

## Protocolo después de seis meses de inactividad

Cuando EL PROYECTO permanezca sin actividad material durante seis meses continuos, deberá procurarse una reunión o comunicación formal para determinar:
...
- contratos vigentes;
- obligaciones;
- estado de marcas y redes;
- continuidad de contenidos;
- posibilidad de reactivación;
- posibilidad de Buy-Out;
- posibilidad de venta o liquidación.

La falta de acuerdo sobre la reactivación no autoriza a una parte para apropiarse unilateralmente de EL PROYECTO.

Mientras se adopta una decisión:

- deberán conservarse cuentas y archivos;
- deberán mantenerse copias de seguridad;
- no podrán eliminarse administradores injustificadamente;
- no podrán desviarse ingresos;
- no podrán transferirse activos esenciales;
- no podrá desconocerse el Capital Empresarial Fundacional;
- deberán conservarse los soportes disponibles.

## Naturaleza de los derechos de Andrés

Los bienes personales de ANDRÉS DAVID MEJÍA HERRERA continuarán siendo de su propiedad.

Los aportes económicos, inversiones, anticipos, préstamos, trabajo, tiempo y riesgo reconocidos a su favor constituirán derechos económicos contractuales.

La existencia de estos derechos no significa que todos los activos empresariales queden automáticamente registrados como propiedad jurídica exclusiva de Andrés.

Sin embargo, dichos activos y el valor construido deberán reconocer su participación cuando se produzca:
