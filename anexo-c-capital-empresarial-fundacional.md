...
Los valores marcados como aproximados podrán precisarse posteriormente, pero no se eliminarán por la ausencia de factura individual cuando exista coherencia con la actividad, contenido, eventos, mensajes, pagos u otros medios legalmente válidos.

| ID | Periodo | Responsable | Concepto | Clasificación | Valor | Estado | Observaciones |
|---|---|---|---|---|---:|---|---|
| CEF-001 | Periodo del Proyecto | Andrés | Publicidad, promoción y pagos a creadores para aumentar alcance y seguidores | Publicidad y crecimiento | $5.000.000 | Aproximado | Aporte personal para desarrollar comunidad y goodwill |
| CEF-002 | 2023-2025 | Andrés | Seis servicios de camioneta para remolcar tráiler y trasladarse a eventos | Logística y transporte | $9.000.000 | Aproximado | Promedio de $1.500.000 por evento |
...
| Concepto | Valor |
|---|---:|
| Publicidad y crecimiento | $5.000.000 |
| Transporte en camionetas | $9.000.000 |
...
- voluntad de obtener resultados deportivos;
- compromiso empresarial;
- exposición patrimonial;
- intención de producir resultados conjuntos;
- utilización de un activo personal para desarrollar EL PROYECTO.

No constituyen automáticamente:

- deuda personal de Luis Felipe;
- cuenta exigible contra EL PROYECTO;
- transferencia del vehículo;
- participación sobre el precio de venta del Swift.

## Regla especial sobre el Yacar Car Cross

El valor total del Yacar Car Cross corresponde a **$65.000.000 COP**.

El estado económico identificado es:

| Concepto | Valor |
|---|---:|
| Aporte pagado por Andrés | $30.000.000 |
| Aporte pagado por Luis Felipe | $20.000.000 |
| Total pagado | $50.000.000 |
| Saldo pendiente | $15.000.000 |
| Total adquisición | $65.000.000 |

La participación provisional sobre lo efectivamente pagado es:

- Andrés: 60 %;
- Luis Felipe: 40 %.

La participación definitiva se recalculará conforme a los pagos reales del saldo pendiente.

El pago de mantenimiento, preparación, llantas, suspensión o gastos operativos no aumentará automáticamente el porcentaje de propiedad, salvo acuerdo escrito diferente.

## Evidencia y nivel de precisión

Los registros anteriores reflejan la información histórica actualmente disponible.

Cuando un valor sea aproximado, deberá conservar expresamente esa clasificación.

No será obligatorio insertar en este Anexo:

- fotografías;
- capturas de pantalla;
- videos;
- enlaces a todas las publicaciones;
- copias completas de conversaciones;
- archivos multimedia;
- duplicados de contenido ya conservado en redes, discos o plataformas.

La existencia de abundante contenido audiovisual relacionado con los eventos, vehículos, preparación y participación podrá utilizarse como evidencia externa cuando sea necesario.

Los documentos contractuales deberán conservar una descripción suficiente de los hechos sin convertirse en un archivo completo de contenido multimedia.

La falta de incorporación física de fotografías o videos dentro del presente Anexo no significa que dichos medios no existan ni que no puedan utilizarse posteriormente como prueba.
